...
def rgba_image_to_svg_contiguous(im, opaque=None, keep_every_point=False):
    ...
    visited = cv2.imshow().new("1", im.size, 0)
...
if __name__ == "__main__":
    ...
    print(png_to_svg('grey.png', contiguous=options.contiguous, opaque=options.opaque, keep_every_point=options.keep_every_point))
